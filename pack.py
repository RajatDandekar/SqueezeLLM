...
if __name__ == "__main__":
    ...
    # ALSO save full model object so you can reload easily for inference
    full_model_path = os.path.splitext(args.save)[0] + "_obj.pt"
    torch.save(model, full_model_path)
    print(f"Full quantized model object saved to: {full_model_path}")
